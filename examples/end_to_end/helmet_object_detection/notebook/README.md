...
- Create a Notebook Server with 1 GPU, 4CPUs, 16GB Memory and 10G volume disk [we suggest to use "kubeflownotebookswg/jupyter-pytorch-cuda-full:v1.6.0" the kubeflow official docker image to create the notebook]
